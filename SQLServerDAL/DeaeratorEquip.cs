...
{
	/// <summary>
	/// 数据访问类:DeaeratorEquip
	/// </summary>
	public partial class DeaeratorEquip:IDeaeratorEquip
	{
		public DeaeratorEquip()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "DeaeratorEquip"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from DeaeratorEquip");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SupervDB.Model.DeaeratorEquip model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DeaeratorEquip(");
			strSql.Append("Wellnum,Updatetime,Model,FactoryNum,Manufacturer,DateManu,CheckResults,IsStandard,ProblemDesc)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SupervDB.Model.DeaeratorEquip model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DeaeratorEquip set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DeaeratorEquip ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SupervDB.Model.DeaeratorEquip GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Wellnum,Updatetime,Model,FactoryNum,Manufacturer,DateManu,CheckResults,IsStandard,ProblemDesc from DeaeratorEquip ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			SupervDB.Model.DeaeratorEquip model=new SupervDB.Model.DeaeratorEquip();
		...
		/// 得到一个对象实体
		/// </summary>
		public SupervDB.Model.DeaeratorEquip DataRowToModel(DataRow row)
		{
			SupervDB.Model.DeaeratorEquip model=new SupervDB.Model.DeaeratorEquip();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Wellnum,Updatetime,Model,FactoryNum,Manufacturer,DateManu,CheckResults,IsStandard,ProblemDesc ");
			strSql.Append(" FROM DeaeratorEquip ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Wellnum,Updatetime,Model,FactoryNum,Manufacturer,DateManu,CheckResults,IsStandard,ProblemDesc ");
			strSql.Append(" FROM DeaeratorEquip ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DeaeratorEquip T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DeaeratorEquip";
