...
namespace SupervDB.SQLServerDAL
{
	...
	/// 数据访问类:EvaluationLog
	/// </summary>
	public partial class EvaluationLog:IEvaluationLog
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "EvaluationLog"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from EvaluationLog");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SupervDB.Model.EvaluationLog model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into EvaluationLog(");
			strSql.Append("Wellnum,Updatetime,ProjectName,Star_Time,End_Time,LogPerNum,LogDay,Savetime)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SupervDB.Model.EvaluationLog model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update EvaluationLog set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from EvaluationLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SupervDB.Model.EvaluationLog GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Wellnum,Updatetime,ProjectName,Star_Time,End_Time,LogPerNum,LogDay,Savetime from EvaluationLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			SupervDB.Model.EvaluationLog model=new SupervDB.Model.EvaluationLog();
		...
		/// 得到一个对象实体
		/// </summary>
		public SupervDB.Model.EvaluationLog DataRowToModel(DataRow row)
		{
			SupervDB.Model.EvaluationLog model=new SupervDB.Model.EvaluationLog();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Wellnum,Updatetime,ProjectName,Star_Time,End_Time,LogPerNum,LogDay,Savetime ");
			strSql.Append(" FROM EvaluationLog ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Wellnum,Updatetime,ProjectName,Star_Time,End_Time,LogPerNum,LogDay,Savetime ");
			strSql.Append(" FROM EvaluationLog ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from EvaluationLog T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "EvaluationLog";
