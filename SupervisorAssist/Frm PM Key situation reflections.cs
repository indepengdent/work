...
{
    public partial class Frm_PM_Key_situation_reflections : Form
    {
        ...
        public Frm_PM_Key_situation_reflections()
        {
            InitializeComponent();
        ...
        private void lodaData(int n)
        {
            ...
            for (int i = 0; i < projects.Length; i++)
            {
                ...
                try
                {
                    ...
                    if (llps.Count > 0 && llps[0].TableName == "重点情况反映")
                    {
        ...
        private void Frm_PM_Key_situation_reflections_Load(object sender, EventArgs e)
        {
            lodaData(0);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                //区分不同的表单
                lpro.TableName = DBUtility.DbHelperSQL.GetVStr("重点情况反映");
