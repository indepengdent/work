...
{
    public partial class Frm_PM_geological_card_layer : Form
    {
        ...
        public Frm_PM_geological_card_layer()
        {
            InitializeComponent();
            ...
            //dhelper.LeftHeaders.Add(new DgvRowHelper.LeftHeader(0, 3, "地质卡层"));
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                //区分不同的表单
                lpro.TableName = DBUtility.DbHelperSQL.GetVStr("地质卡层");
        ...
        private void lodaData(int n)
        {
            ...
            for (int i = 0; i < projects.Length; i++)
            {
                ...
                try
                {
                    ...
                    if (llps.Count > 0 && llps[0].TableName == "地质卡层")
                    {
        ...
        private void Frm_PM_geological_card_layer_Load(object sender, EventArgs e)
        {
            lodaData(0);
        }
