...
namespace SupervDB.SQLServerDAL
{
	...
	/// 数据访问类:DeviceChange
	/// </summary>
	public partial class DeviceChange:IDeviceChange
	{
		public DeviceChange()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "DeviceChange"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from DeviceChange");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SupervDB.Model.DeviceChange model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DeviceChange(");
			strSql.Append("Wellnum,Updatetime,EquipName,Model,FactoryNum,Manufacturer,DateManu,CheckResults,Savetime)");
			...
			parameters[8].Value = model.Savetime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SupervDB.Model.DeviceChange model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DeviceChange set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DeviceChange ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SupervDB.Model.DeviceChange GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Wellnum,Updatetime,EquipName,Model,FactoryNum,Manufacturer,DateManu,CheckResults,Savetime from DeviceChange ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			SupervDB.Model.DeviceChange model=new SupervDB.Model.DeviceChange();
		...
		/// 得到一个对象实体
		/// </summary>
		public SupervDB.Model.DeviceChange DataRowToModel(DataRow row)
		{
			SupervDB.Model.DeviceChange model=new SupervDB.Model.DeviceChange();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Wellnum,Updatetime,EquipName,Model,FactoryNum,Manufacturer,DateManu,CheckResults,Savetime ");
			strSql.Append(" FROM DeviceChange ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Wellnum,Updatetime,EquipName,Model,FactoryNum,Manufacturer,DateManu,CheckResults,Savetime ");
			strSql.Append(" FROM DeviceChange ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DeviceChange T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DeviceChange";
