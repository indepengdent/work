...
namespace SupervDB.SQLServerDAL
{
	...
	/// 数据访问类:PersonChange
	/// </summary>
	public partial class PersonChange:IPersonChange
	{
		public PersonChange()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "PersonChange"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from PersonChange");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SupervDB.Model.PersonChange model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into PersonChange(");
			strSql.Append("Wellnum,Updatetime,Num,Name,WorkPlace,JobTitle,JobNum,JobLevel,WellConcert,HS2Cert,HSECert,FiveSCert,CheckResults,Savetime)");
			...
			parameters[13].Value = model.Savetime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SupervDB.Model.PersonChange model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update PersonChange set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from PersonChange ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SupervDB.Model.PersonChange GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Wellnum,Updatetime,Num,Name,WorkPlace,JobTitle,JobNum,JobLevel,WellConcert,HS2Cert,HSECert,FiveSCert,CheckResults,Savetime from PersonChange ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			SupervDB.Model.PersonChange model=new SupervDB.Model.PersonChange();
		...
		/// 得到一个对象实体
		/// </summary>
		public SupervDB.Model.PersonChange DataRowToModel(DataRow row)
		{
			SupervDB.Model.PersonChange model=new SupervDB.Model.PersonChange();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Wellnum,Updatetime,Num,Name,WorkPlace,JobTitle,JobNum,JobLevel,WellConcert,HS2Cert,HSECert,FiveSCert,CheckResults,Savetime ");
			strSql.Append(" FROM PersonChange ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Wellnum,Updatetime,Num,Name,WorkPlace,JobTitle,JobNum,JobLevel,WellConcert,HS2Cert,HSECert,FiveSCert,CheckResults,Savetime ");
			strSql.Append(" FROM PersonChange ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from PersonChange T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "PersonChange";
