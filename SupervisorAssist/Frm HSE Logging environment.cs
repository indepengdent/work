...
{
    public partial class Frm_HSE_Logging_environment : Form
    {
        ...
        public Frm_HSE_Logging_environment()
        {
            InitializeComponent();
            ...
            dhelper.LeftHeaders.Add(new DgvRowHelper.LeftHeader(0, 6, "录井环境"));
        }
        ...
        private void lodaData(int n)
        {
            ...
            for (int i = 0; i < projects.Length; i++)
            {
                ...
                try
                {
                    ...
                    if (llps.Count > 0 && llps[0].TableName == "录井环境")
                    {
        ...
        private void Frm_HSE_Logging_environment_Load(object sender, EventArgs e)
        {
            lodaData(0);
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                //区分不同的表单
                lpro.TableName = DBUtility.DbHelperSQL.GetVStr("录井环境");
