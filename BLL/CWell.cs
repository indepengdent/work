...
namespace SupervDB.BLL
{
	...
	{
		private readonly ICWell dal=DataAccess.CreateCWell();
		public CWell()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public SupervDB.Model.CWell GetModelByCache(string Wellnum)
		{
			
			string CacheKey = "CWellModel-" + Wellnum;
			...
			return (SupervDB.Model.CWell)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<SupervDB.Model.CWell> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SupervDB.Model.CWell> DataTableToList(DataTable dt)
		{
			List<SupervDB.Model.CWell> modelList = new List<SupervDB.Model.CWell>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SupervDB.Model.CWell model;
