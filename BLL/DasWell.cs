...
namespace SupervDB.BLL
{
	...
	/// DasWell
	/// </summary>
	public partial class DasWell
	{
		private readonly IDasWell dal=DataAccess.CreateDasWell();
		public DasWell()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public SupervDB.Model.DasWell GetModelByCache(string Wellnum)
		{
			
			string CacheKey = "DasWellModel-" + Wellnum;
			...
			return (SupervDB.Model.DasWell)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<SupervDB.Model.DasWell> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SupervDB.Model.DasWell> DataTableToList(DataTable dt)
		{
			List<SupervDB.Model.DasWell> modelList = new List<SupervDB.Model.DasWell>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SupervDB.Model.DasWell model;
